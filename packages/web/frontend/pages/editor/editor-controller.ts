...
import { createEditorPage } from '../../components/editor-page';
import { attachNavbarListeners } from '../../components/navbar';

// Module-level Monaco editor instance — shared across all editor-page listener closures.
...
export function renderEditorPage(data?: any): void {
  ...
  // Dispose any existing Monaco instance before replacing the DOM
  disposeEditor();

  app.innerHTML = createEditorPage();
  attachNavbarListeners();
  attachEditorPageListeners();
...
function attachEditorPageListeners(): void {
...
async function loadDefaultExample(): Promise<void> {
...
function updateLineCount(code: string): void {
