...
- [src/airfield.langium](src/airfield.langium) -  The grammar definition of your language
- [src/airfield-module.ts](src/airfield-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/airfield-validator.ts](src/airfield-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/airfield.monarch.ts](src/syntaxes/airfield.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/airfield.tmLanguage.json](syntaxes/airfield.tmLanguage.json) - Textmate based syntax highlighting instructions.
