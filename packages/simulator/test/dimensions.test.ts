...
import { mkAircraft, mkClearance } from './helpers/fixtures.js';
...
describe('calculateEffectiveDimensions', () => {
    test('no clearance — effective dimensions equal nominal', () => {
        const dims = calculateEffectiveDimensions(mkAircraft('TestAircraft', 11, 8.3, 2.7) as any);
    ...
    test('uses aircraft.tailHeight when explicitly provided', () => {
        const dims = calculateEffectiveDimensions(mkAircraft('TestAircraft', 11, 8.3, 2.7, 3.5) as any);
    ...
    test('lateral clearance (lateralMargin) adds to effective wingspan', () => {
        const dims = calculateEffectiveDimensions(mkAircraft('TestAircraft', 11, 8.3, 2.7) as any, mkClearance('STD', 1, 0, 0) as any);
    ...
    test('longitudinal clearance (longitudinalMargin) adds to effective length', () => {
        const dims = calculateEffectiveDimensions(mkAircraft('TestAircraft', 11, 8, 2.7) as any, mkClearance('STD', 0, 0.5, 0) as any);
    ...
    test('vertical clearance (verticalMargin) adds to effective height and tailHeight', () => {
        const dims = calculateEffectiveDimensions(mkAircraft('TestAircraft', 11, 8.3, 2.7) as any, mkClearance('STD', 0, 0, 0.3) as any);
    ...
    test('vertical clearance also adds to explicit tailHeight', () => {
        const dims = calculateEffectiveDimensions(mkAircraft('TestAircraft', 11, 8.3, 2.7, 3.5) as any, mkClearance('STD', 0, 0, 0.5) as any);
    ...
    test('rawAircraft preserves nominal (pre-clearance) dimensions', () => {
        const dims = calculateEffectiveDimensions(mkAircraft('TestAircraft', 11, 8.3, 2.7, 3.5) as any, mkClearance('STD', 1, 0.5, 0.3) as any);
    ...
    test('clearanceName is captured from the clearance envelope', () => {
        const dims = calculateEffectiveDimensions(mkAircraft('TestAircraft', 11, 8, 3) as any, mkClearance('MILITARY', 1, 1, 0.5) as any);
    ...
    test('all three margins applied simultaneously', () => {
        const dims = calculateEffectiveDimensions(
            mkAircraft('TestAircraft', 10, 8, 3) as any,
